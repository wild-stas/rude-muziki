...
class user_playlist_items
{
	...
	{
		$q = new query_select(RUDE_DATABASE_TABLE_USER_PLAYLIST_ITEMS);
		$q->order_by(RUDE_DATABASE_TABLE_USER_PLAYLIST_ITEMS_PRIMARY_KEY, 'DESC');
		$q->limit($n);
		$q->query();
	...
	{
		$q = new query_select(RUDE_DATABASE_TABLE_USER_PLAYLIST_ITEMS);
		$q->order_by(RUDE_DATABASE_TABLE_USER_PLAYLIST_ITEMS_PRIMARY_KEY, 'ASC');
		$q->limit($n);
		$q->query();
	...
	{
		$database = database();
		$database->query('SELECT COUNT(*) as count FROM ' . RUDE_DATABASE_TABLE_USER_PLAYLIST_ITEMS);
